    ...
    <div class="row justify-content-center my-5">
        <div class="col-md-8 my-5">
            <div class="card">
                ...
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="portfolioModal5Label" align="center">Login</h2>
                <!-- Icon Divider-->
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}" data-toggle="modal" data-target="#portfolioModal4">
